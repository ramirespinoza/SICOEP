<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100" style="display: flex; flex-direction: row ;background-color: rgb(227, 242, 253);">
            <nav class="bg-white border-b border-gray-100 py-6" style="display: flex; flex-direction: column" >
                <!-- Primary Navigation Menu -->
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" >
                    <div class="flex justify-between h-16" style="display: flex; flex-direction: column;" >
                        <div class="flex" style="display: flex; flex-direction: column">
                            <!-- Logo --

                            <!-- Navigation Links -->
                            <div class="hidden" style="display: flex; flex-direction: column; width: 150px">
